...
\item Por último, se si mira la figura \ref{fig:aprendizaje}, se observa que la Latent ODE tuvo un mejor aprendizaje que la Neural ODE, debido a que la perdida bajó considerablemente, mientras que con la Neural ODE se mantuvo casi constante. Eso si, la perdida de la Neural ODE es menor a la perdida de la Latent ODE, a pesar de que esta última tuviera un mejor aprendizaje.
\end{itemize}

\begin{thebibliography}{9}

\bibitem{chen2018}
Chen, R. T. Q., Rubanova, Y., Bettencourt, J., and Duvenaud, D. K. (2018). \textit{Neural Ordinary Differential Equations}. Advances in Neural Information Processing Systems.

\bibitem{rubanova2019}
Rubanova, Y., Chen, R. T. Q., and Duvenaud, D. K. (2019). \textit{Latent Ordinary Differential Equations for Irregularly-Sampled Time Series}. Advances in Neural Information Processing Systems.
